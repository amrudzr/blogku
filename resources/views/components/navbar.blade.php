<nav class="navbar bg-base-300 shadow-md">
    <div class="flex-1">
        <a href="{{ route('home.page') }}" class="btn btn-ghost text-xl me-2">{{ config('app.name') }}</a>
    ...
    <div class="flex-none gap-4">
        ...
        @else
            <div class="flex-auto navbar-end gap-2">
                <a class="btn btn-outline btn-primary" href="{{ route('register.page') }}">Signup</a>
                <a class="btn btn-active btn-primary" href="{{ route('login.page') }}">Login</a>
            </div>
        @endif
    </div>
    @endif
